...
#     start_afk_time = Column(Time, default=None, nullable=True)
...
#     randomizer_duration_activity: Mapped[float] = mapped_column(default=0.4)
#     range_new_map_id: Mapped[int] = mapped_column(nullable=False)
#     range_new_map: Mapped[RangeWait] = relationship(foreign_keys=[range_new_map_id])
#     range_wait_id: Mapped[int] = mapped_column(nullable=False)
